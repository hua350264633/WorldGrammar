        ...
        if (!loaded) {
            ...
            $table.bootstrapTable({
                ...
                columns: [{
                    ...
                    title: '操作',
                    formatter: function (value, row, index) {
                        return '<button type="button" class="btn btn-primary" onclick="ShowEdit(\'' + row.LoginName + '\')"><span class="glyphicon glyphicon-edit"></span>编辑</button>&nbsp;&nbsp;' +
                               '<button type="button" class="btn btn-danger" onclick="DelUser(\'' + row.LoginName + '\')"><span class="glyphicon glyphicon-remove"></span>删除</button>&nbsp;&nbsp;' +
                               '<button type="button" class="btn btn-warning" onclick="ResetPwd(\'' + row.LoginName + '\')"><span class="glyphicon glyphicon-lock"></span>重置</button>';
                    },
                    align: "center",
                    width: "240"
                }]
